...
const USB_DEVICE_QUALIFIER deviceQualifierDescriptor1 =
{
    ...
    0x00,                               // Number of possible configurations
...
{
    NULL,                       // Full speed descriptor.
    0,                          // Total number of full speed configurations available .
    NULL,                       // Pointer to array of full speed configurations descriptors.

    &highSpeedDeviceDescriptor, // High speed device descriptor.
